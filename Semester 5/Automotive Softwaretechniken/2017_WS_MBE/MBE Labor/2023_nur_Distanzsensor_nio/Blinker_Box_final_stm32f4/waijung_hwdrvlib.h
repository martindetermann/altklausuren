 ...
 * ########################################################################
 */
#define OutputDigitalOutput_C0         Peripheral_BB(GPIOC->ODR, 0) /* Output pin */
#define OutputDigitalOutput_C1         Peripheral_BB(GPIOC->ODR, 1) /* Output pin */
#define OutputDigitalOutput_C2         Peripheral_BB(GPIOC->ODR, 2) /* Output pin */
#define OutputDigitalOutput_C3         Peripheral_BB(GPIOC->ODR, 3) /* Output pin */
#define OutputDigitalOutput_C4         Peripheral_BB(GPIOC->ODR, 4) /* Output pin */
#define OutputDigitalOutput_C5         Peripheral_BB(GPIOC->ODR, 5) /* Output pin */
#define OutputDigitalOutput_C6         Peripheral_BB(GPIOC->ODR, 6) /* Output pin */
#define OutputDigitalOutput_C7         Peripheral_BB(GPIOC->ODR, 7) /* Output pin */
#define OutputDigitalOutput_C8         Peripheral_BB(GPIOC->ODR, 8) /* Output pin */
#define OutputDigitalOutput_C9         Peripheral_BB(GPIOC->ODR, 9) /* Output pin */
...
typedef struct {
  uint8_t d0;
} CANReceive2_DATA_STRUCT;

extern CANReceive2_DATA_STRUCT *CANReceive2_data;
extern CanRxMsg CANReceive2_Msg;
...
typedef struct {
  uint16_t d0;
} CANReceive3_DATA_STRUCT;

extern CANReceive3_DATA_STRUCT *CANReceive3_data;
extern CanRxMsg CANReceive3_Msg;
...
typedef struct {
  uint8_t d0;
} CANReceive4_DATA_STRUCT;

extern CANReceive4_DATA_STRUCT *CANReceive4_data;
extern CanRxMsg CANReceive4_Msg;
...
extern UART_TX_STATE SetupUARTSetup_Tx_State;
