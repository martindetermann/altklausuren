...
session_start();
if (!isset($_SESSION["userid"]) | $_SESSION["type"]!=0){
...
<head>
    ...
    <script src="header_loggedin.js" type="text/javascript" defer></script>
</head>
<style>
    .showAppointments {
        position: absolute;
...
<div class="showAppointments" style="position:absolute; left:5%">
    ...
    <h1 style="top:55%; color:greenyellow; font-family: arial">Nachrichten entfernen</h1>
    <form style="position:absolute; top:60%" action="inc/removemessage_inc.php" method="post">
        <?php
...
<div class="showAppointments" style="position:absolute;left:56%">
    <h1 style="top:5%;left:31%">Gebuchte Termine</h1>
        <table>
            ...
            <?php
            $cErr = fitBridge_displayAppointments($_SESSION["this_username"]);
            ?>
        </table>
</div>
</body>
