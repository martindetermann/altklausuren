...
#define DigitalOutput_C6               Peripheral_BB(GPIOC->ODR, 6) /* Output pin */
#define DigitalOutput_C7               Peripheral_BB(GPIOC->ODR, 7) /* Output pin */
#define DigitalOutput_C8               Peripheral_BB(GPIOC->ODR, 8) /* Output pin */
#define DigitalOutput_C9               Peripheral_BB(GPIOC->ODR, 9) /* Output pin */
