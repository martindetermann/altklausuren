...
"%WaijungRoot%\utils\gnumake382-w32\gnumake382-w32" -f Schloss_Box_final.mk 
REM "%WaijungRoot%\utils\gnumake382-w32\gnumake382-w32" -f Schloss_Box_final.mk clean-obj
