...
/* InputDigitalInput */
#define InputDigitalInput_C0           Peripheral_BB(GPIOC->IDR, 0) /* Output pin */
#define InputDigitalInput_C1           Peripheral_BB(GPIOC->IDR, 1) /* Output pin */
 ...
 * ########################################################################
 */
extern CanTxMsg CANTransmit_mTxMsg;
