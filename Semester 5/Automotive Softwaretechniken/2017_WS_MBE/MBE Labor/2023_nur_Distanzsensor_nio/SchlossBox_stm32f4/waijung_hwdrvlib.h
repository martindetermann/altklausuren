...
/* DigitalInput */
#define DigitalInput_C0                Peripheral_BB(GPIOC->IDR, 0) /* Output pin */
#define DigitalInput_C1                Peripheral_BB(GPIOC->IDR, 1) /* Output pin */
 ...
 * ########################################################################
 */
extern CanTxMsg CANTransmit_bTxMsg;
