...
<div class="appointmentForm">
  <h1 style="margin-left: 3%">Registrierung</h1>
    <div>
        <?php
        session_start();
        if (isset($_SESSION["pastDateWarning"]) && $_SESSION["pastDateWarning"]==2) {
            echo "<p>Bitte keine Felder Leer lassen!</p>";
            $_SESSION["pastDateWarning"]=0;
        } else if (isset($_SESSION["pastDateWarning"])&&$_SESSION["pastDateWarning"]==1) {
            echo "<p>Geburtsdatum unplausibel!</p>";
            $_SESSION["pastDateWarning"]=0;
        } else if (isset($_SESSION["pastDateWarning"])&&$_SESSION["pastDateWarning"]==4) {
  ...
  <form action="inc/registration_inc_trainer.php" method="post">
    <div style="top:10%">
      <p>Vorname</p>
    ...
    <div style="top:60%; height:20%">
      <p>Über mich:</p>
      <input style="top:10%" type="string" class = "form-control" name="about" id="about"/>
    </div>
