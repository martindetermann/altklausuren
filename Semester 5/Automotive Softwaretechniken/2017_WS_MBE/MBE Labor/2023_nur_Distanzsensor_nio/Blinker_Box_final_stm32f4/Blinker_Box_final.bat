...
"%WaijungRoot%\utils\gnumake382-w32\gnumake382-w32" -f Blinker_Box_final.mk 
REM "%WaijungRoot%\utils\gnumake382-w32\gnumake382-w32" -f Blinker_Box_final.mk clean-obj
