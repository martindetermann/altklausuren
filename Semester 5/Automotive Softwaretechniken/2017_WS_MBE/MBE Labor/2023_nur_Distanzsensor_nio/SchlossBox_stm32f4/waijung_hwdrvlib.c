...
/* ########################################################################
 * Name: <S2>/CAN Transmit
 * Id: CANTransmit_b
 * ########################################################################
 */
CanTxMsg CANTransmit_bTxMsg;
void enable_CANTransmit_b(void)
{
  // Initial the module
  WAIJUNG_CAN1_INIT ();

  /* Transmit Structure */
  CANTransmit_bTxMsg.StdId = 25;
  CANTransmit_bTxMsg.ExtId = 0;
  CANTransmit_bTxMsg.RTR = CAN_RTR_DATA;
  CANTransmit_bTxMsg.IDE = CAN_Id_Standard;
  CANTransmit_bTxMsg.DLC = 1;
}

void disable_CANTransmit_b(void)
{
}
...
/* ########################################################################
 * Name: <Root>/Digital Input
 * Id: DigitalInput
 * ########################################################################
 */
void enable_DigitalInput(void)
{
  GPIO_InitTypeDef GPIO_InitStructure;
  RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOC, ENABLE);

  /* Configure PC in input None mode for DigitalInput Block*/
