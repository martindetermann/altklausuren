...
/* ########################################################################
 * Name: <S54>/CAN Transmit
 * Id: CANTransmit_m
 * ########################################################################
 */
CanTxMsg CANTransmit_mTxMsg;
void enable_CANTransmit_m(void)
{
  // Initial the module
  WAIJUNG_CAN1_INIT ();

  /* Transmit Structure */
  CANTransmit_mTxMsg.StdId = 25;
  CANTransmit_mTxMsg.ExtId = 0;
  CANTransmit_mTxMsg.RTR = CAN_RTR_DATA;
  CANTransmit_mTxMsg.IDE = CAN_Id_Standard;
  CANTransmit_mTxMsg.DLC = 1;
}

void disable_CANTransmit_m(void)
{
}

/* ########################################################################
 * Name: <S1>/Digital Input
 * Id: InputDigitalInput
 * ########################################################################
 */
void enable_InputDigitalInput(void)
{
  GPIO_InitTypeDef GPIO_InitStructure;
  RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOC, ENABLE);

  /* Configure PC in input None mode for InputDigitalInput Block*/
...
void enable_CANReceive(void)
{
  ...
  if (CANReceive_filter_number < CAN_FILTER_COUNT) {
    ...
    CANReceive_FilterInitStructure.CAN_FilterIdHigh = 0x240;
...
void enable_CANReceive1(void)
{
  ...
  if (CANReceive1_filter_number < CAN_FILTER_COUNT) {
    ...
    CANReceive1_FilterInitStructure.CAN_FilterIdHigh = 0x180;
